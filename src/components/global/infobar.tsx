...
interface IInfoBarProps {
  ...
  notifications: IGetNotificationAndUser[];
  role?: Role;
  className?: string;
  subAccountId?: string;
}

const InfoBar: React.FC<IInfoBarProps> = ({ notifications, subAccountId, className, role }) => {
  const [allNotifications, setAllNotifications] = useState<IGetNotificationAndUser[]>(notifications);

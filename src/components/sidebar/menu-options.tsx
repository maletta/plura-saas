            ...
            <Command className="rounded-lg">
              ...
              <CommandList className="pb-16">
                ...
                {(user?.role === "AGENCY_OWNER" ||
                  ...
                  user.Agency && (
                    <CommandGroup heading="Agency" tabIndex={100}>
                  ...
                  {(!!subAccounts)
                    ? subAccounts.map((subaccount) => (
                      <CommandItem key={subaccount.id}>
                        {defaultOpen ? (
                          // se for renderizar em dispositivo de tela grande
                          < Link
                          ...
                          // se for renderizar em dispositivo de tela pequena
                          <SheetClose asChild>
                            <Link
                              href={`/subaccount/${subaccount.id}`}
                              className="flex gap-4 w-full h-full"
                    ...
                    <Button
                      ...
                      onClick={() => setOpen(
                        <CustomModal
                          ...
                          subheading="You can switch between your agency account and the subaccount from de the sidebar">
                          <SubAccountDetails
